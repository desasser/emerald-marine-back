module.exports = {
    products: [
        ...
        },
        {
            ...
            categories: ['Overboard Alerting Products'],
            image: 'https://res.cloudinary.com/dccnlakey/image/upload/v1624403639/Emerald%20Marine%20Images/y4da7typsl5rlmbjbnel.jpg',
            alt: 'ALERT418® Man-Overboard Receiver',
            weight: '13 oz',
            length: '6',
            width: '3.75',
            height: '1.875',
            details: '[{"index": "0", "heading": "Description", "content": "The ALERT418® Man-Overboard Receiver immediately alarms the crew and vessel of a man-overboard situation in seconds. In addition to the fastest man-overboard alert, you can wire for engine-kill and other external alerting functions. When the difference between life and death is three minutes, the best chance of a successful rescue is by the crew onboard. The ALERT418 Receiver is installed aboard the vessel or on land for shoreside awareness. When the ALERT418 Receiver picks up an ALERT2 or ALERT418 Transmitter signal, an internal siren sounds in the Receiver and a digital display is illuminated with important information such as the location of the vessel at the time of the incident and ID number of ALERT418 Transmitter that is transmitting (ALERT2 Transmitter does not transmit unit ID). In addition to this valuable information is a Relevant Signal Strength Indicator (RSSI) to provide a numeric reading of the strength of the ALERT Transmitter. The ALERT418 Receiver also has the ability to be wired so it can shut down the engine, mark a position on a compatible Chart Plotter, sound external alarm systems, and other options."}, {"index": "1", "heading": "Automatically Activated", "content": "Upon immersion in water, the ALERT Transmitter instantly sends a radio signal to the onboard ALERT418 Receiver to alarm the crew and vessel of a fall-overboard."}, {"index": "2", "heading": "Alerts in Seconds", "content": "When every second count, the ALERT Man-Overboard Alarm System instantaneously alarms the vessel, providing the crew the critical extra seconds needed for a successful man overboard rescue. Unlike AIS, the response of the ALERT418 Receiver is immediate. There is no lag time connecting with satellites."}, {"index": "3", "heading": "Wired for Engine Kill", "content": "For singlehanders and solo fisherman, the ALERT Man-Overboard Alarm System can be wired to shut off the engine in the event of a fall-overboard, enabling the man overboard to get back to the boat."}, {"index": "4", "heading": "Plot Overboard Waypoint", "content": "The ALERT418 Man-Overboard Receiver can easily connect to a compatible plotter to instantly mark the location of the fall overboard. Sending a NMEA 0183 compliant sentence, compatible chartplotting software will display the location of the incident. The ALERT418 Receiver can be directly wired to the boat’s 12-volt wiring system or connected via an optional 110-volt power supply. "}, {"index": "5", "heading": "Displays Valuable Transmitter Unit Information", "content": "Unit ID number – to immediately know who fell overboard; Signal strength indicator – find the MOB quicker based on single strength of the MOB’s transmitter; Low battery indicator – easily know when a transmitter needs new batteries to ensure the crew is always prepared for a man-overboard situation. An ALERT418 Receiver supports an unlimited number of ALERT2 or ALERT418 Transmitters."}, {"index": "6", "heading": "ALERT2 Customer Looking to Upgrade?", "content": "The ALERT418 Receiver has the same dimensions as the ALERT2 Receiver, therefore, you can easily swap out the two units. Order part number AR401 if you only need the ALERT418 Receiver, GPS antenna, and serial cable. You will then be able to use your existing ALERT antenna and coaxial cable to operate the device. If you purchased your ALERT2 Receiver within the past year you may be eligible for a product rebate towards the ALERT418 Receiver."}]'
        },
        {
            ...
            image: 'https://res.cloudinary.com/dccnlakey/image/upload/v1624489525/Emerald%20Marine%20Images/ivfxb0mzkfzmdrrtmtal.jpg',
            ...
            width: '1.5',
            height: '1', 
            details: '[{"index": "0", "heading": "Description", "content": "The ALERT418® Man-Overboard Transmitter is a lightweight water-activated Transmitter that easily attaches to a Personal Flotation Device. Upon immersion, the Transmitter instantly alerts the crew of a fall-overboard. The proprietary 418Mhz frequency allows it to be automatically activated so it doesn’t have to rely on additional equipment to be triggered. The ALERT418 Transmitter has been engineered with the latest technology, making it more efficient and easy to use. The durable Spray Tight Pouch protects the ALERT418 Transmitter from accidentally activating due to extreme water conditions onboard, while enabling it to activate when immersed in water due to a fall-overboard occurrence."}, {"index": "1", "heading": "Easy to Use and Wear", "content": "It is slightly smaller and lighter than the ALERT2 Transmitter. The ALERT418 can easily clip to a self-inflating PFD, offering comfortable MOB protection. It is water activated so the man overboard doesn’t need to do anything to trigger the alarm. The Durable Spray Tight Pouch folds over the Transmitter, making it seamless to wear. The ALERT418 Transmitter is always in an armed state, with an easy “reset” button if you need to turn the Transmitter off after activation. Now there is no need to worry if a crew member forgot to “arm the transmitter” before heading off to their watch."}, {"index": "2", "heading": "Quickly Locate", "content": "The unit includes 6 LED lights for illumination when water-activated, providing enhanced visibility of the fall overboard."}, {"index": "3", "heading": "More Efficient", "content": "The low battery indicator lets you know if the readily available CR123A lithium batteries need replacement."}, {"index": "4", "heading": "Wired for Engine Kill", "content": "For singlehanders and solo fisherman, the ALERT Man-Overboard Alarm System can be wired to shut off the engine in the event of a fall-overboard, enabling the man overboard to get back to the boat."}, {"index": "5", "heading": "Plot Overboard Waypoint", "content": "The ALERT Man-Overboard Alarm System can easily connect to a compatible plotter to instantly mark the location of the fall overboard. Making it easier to home in the person that fell overboard. Ease of use, automatic, and an intelligent messaging system, makes the ALERT418 Transmitter an essential safety device for anyone on the water. The ALERT418 Transmitter is compatible with the ALERT418 and ALERT2 Receivers. ALERT418 Transmitters require an ALERT418 or ALERT2 Receiver to transmit to."}]'
        },
        {
            ...
            categories: ['Overboard Alerting Products'],
            image: 'https://res.cloudinary.com/dccnlakey/image/upload/v1624403446/Emerald%20Marine%20Images/hanhe5pq0cdqnb12dbgr.jpg',
            ...
            width: '1.5',
            height: '.75', 
            details: '[{"index": "0", "heading": "Description", "content": "The ALERT2 Man-Overboard Transmitter™ is a lightweight water-activated Transmitter that easily attaches to a Personal Flotation Device (PFD). Upon immersion, the Transmitter instantly alerts the crew of a fall-overboard. The proprietary 418Mhz frequency allows it to be automatically activated so it doesn’t have to rely on additional equipment to be triggered."}, {"index": "1", "heading": "Easy to Use and Wear", "content": "The ALERT2 Transmitter easily attaches to a PFD, offering comfortable MOB protection. It is water activated so the man overboard doesn’t need to do anything to trigger the alarm."}, {"index": "2", "heading": "Wired for Engine Kill", "content": "For singlehanders and solo fisherman, the ALERT Man-Overboard Alarm System can be wired to shut off the engine in the event of a fall-overboard, enabling the man overboard to get back to the boat."}, {"index": "3", "heading": "Plot Overboard Waypoint", "content": "The ALERT Man-Overboard Alarm System can easily connect to a compatible plotter to instantly mark the location of the fall overboard. Making it easier to home in the person that fell overboard. The ALERT2 Transmitter has been saving lives for over 20 years. This proven, reliable, and durable safety device is essential to protect anyone on the water. ALERT2 Transmitters require an ALERT2 Receiver or ALERT418 Receiver to transmit to."}]'
        },
        {
            ...
            categories: ['Accessories'],
            image: 'https://res.cloudinary.com/dccnlakey/image/upload/v1624402993/Emerald%20Marine%20Images/bwmxyhxsm0vkp4sm03lp.jpg',
            video: 'https://www.youtube.com/watch?v=Bnh3caPYvhY&feature=youtu.be',
            ...
            width: '1.5',
            height: '.75',
            details: '[{"index": "0", "heading": "Description", "content": "The ALERT2 Man-Overboard Transmitter™ is a lightweight water-activated Transmitter that easily attaches to a Personal Flotation Device (PFD). Upon immersion, the Transmitter instantly alerts the crew of a fall-overboard. The proprietary 418Mhz frequency allows it to be automatically activated so it doesn’t have to rely on additional equipment to be triggered. The Durable Spray Tight Pouch protects the ALERT2 Transmitter from accidentally activating due to extreme water conditions onboard, while enabling it to activate when immersed in water due to a fall-overboard occurrence."}, {"index": "1", "heading": "Easy to Use and Wear", "content": "The ALERT2 Transmitter easily attaches to a PFD, offering comfortable MOB protectionn. It is water activated so the man overboard doesn’t need to do anything to trigger the alarm. The Durable Spray Tight Pouch folds over the Transmitter, making it seamless to wear."}, {"index": "2", "heading": "Wired for Engine Kill", "content": "For singlehanders and solo fisherman, the ALERT Man-Overboard Alarm System can be wired to shut off the engine in the event of a fall-overboard, enabling the man overboard to get back to the boat."}, {"index": "3", "heading": "Plot Overboard Waypoint", "content": "The ALERT Man-Overboard Alarm System can easily connect to a compatible plotter to instantly mark the location of the fall overboard. Making it easier to home in the person that fell overboard. The ALERT2 Transmitter has been saving lives for over 20 years. This proven, reliable, and durable safety device is essential to protect anyone on the water."}]'
        },
        {
            ...
            width: '1.5',
            height: '.75',
            details: '[{"index": "0", "heading": "Description", "content": "The ALERT2 Man-Overboard Transmitter™ is a lightweight water-activated Transmitter that easily attaches to a Personal Flotation Device (PFD). Upon immersion, the Transmitter instantly alerts the crew of a fall-overboard. The proprietary 418Mhz frequency allows it to be automatically activated so it doesn’t have to rely on additional equipment to be triggered. The ALERT2 Man-Overboard Transmitter Intrinsically Safe Model is engineered for extra protection for safe operation of electrical equipment in hazardous areas. This model is extensively used by our customers in the oil and coal industries. The transmitter is certified Class 1, Div 1, Group D."}, {"index": "1", "heading": "Easy to Use and Wear", "content": "The ALERT2 Transmitter easily attaches to a PFD, offering comfortable MOB protection. It is water activated so the man overboard doesn’t need to do anything to trigger the alarm."}, {"index": "2", "heading": "Wired for Engine Kill", "content": "For singlehanders and solo fisherman, the ALERT Man-Overboard Alarm System can be wired to shut off the engine in the event of a fall-overboard, enabling the man overboard to get back to the boat."}, {"index": "3", "heading": "Plot Overboard Waypoint", "content": "The ALERT Man-Overboard Alarm System can easily connect to a compatible plotter to instantly mark the location of the fall overboard. Making it easier to home in the person that fell overboard. The ALERT2 Transmitter has been saving lives for over 20 years. This proven, reliable, and durable safety device is essential to protect anyone on the water. ALERT2 Transmitters require an ALERT2 Receiver or ALERT418 Receiver to transmit to."}]'
        },
        {
            ...
            image: 'https://res.cloudinary.com/dccnlakey/image/upload/v1624404275/Emerald%20Marine%20Images/zs12t7r18tubbkzsxc4n.jpg',
            video: 'https://www.youtube.com/watch?v=Bnh3caPYvhY&feature=youtu.be',
            ...
            width: '1.5',
            height: '.75',
            details: '[{"index": "0", "heading": "Description", "content": "The ALERT2 Man-Overboard Transmitter™ is a lightweight water-activated Transmitter that easily attaches to a Personal Flotation Device (PFD). Upon immersion, the Transmitter instantly alerts the crew of a fall-overboard. The proprietary 418Mhz frequency allows it to be automatically activated so it doesn’t have to rely on additional equipment to be triggered. The ALERT2 Man-Overboard Transmitter Intrinsically Safe Model is engineered for extra protection for safe operation of electrical equipment in hazardous areas. This model is extensively used by our customers in the oil and coal industries. The transmitter is certified Class 1, Div 1, Group D. The Durable Spray Tight Pouch protects the ALERT2 Transmitter from accidentally activating due to extreme water conditions onboard, while enabling it to activate when immersed in water due to a fall-overboard occurrence."}, {"index": "1", "heading": "Easy to Use and Wear", "content": "The ALERT2 Transmitter easily attaches to a PFD, offering comfortable MOB protection. It is water activated so the man overboard doesn’t need to do anything to trigger the alarm. The Durable Spray Tight Pouch folds over the Transmitter, making it seamless to wear."}, {"index": "2", "heading": "Wired for Engine Kill", "content": "For singlehanders and solo fisherman, the ALERT Man-Overboard Alarm System can be wired to shut off the engine in the event of a fall-overboard, enabling the man overboard to get back to the boat.", {"index": "3", "heading": "Plot Overboard Waypoint", "content": "The ALERT Man-Overboard Alarm System can easily connect to a compatible plotter to instantly mark the location of the fall overboard. Making it easier to home in the person that fell overboard. The ALERT2 Transmitter has been saving lives for over 20 years. This proven, reliable, and durable safety device is essential to protect anyone on the water. ALERT2 Transmitters require an ALERT2 Receiver or ALERT418 Receiver to transmit to."}]'
        },
        {
            ...
            width: '2',
            height: '6',
            details: '[{"index": "0", "heading": "Description", "content": "The ALERT2 Man-Overboard Receiver™ immediately alarms the crew and vessel of a man-overboard situation. When the difference between life and death is three minutes, the best chance of a successful rescue is by the crew onboard. The ALERT2 Receiver is installed aboard the vessel. When the ALERT2 Receiver picks up an ALERT2 or ALERT418 Transmitter signal, an internal siren sounds and a red Man-Overboard light is illuminated. The ALERT2 Receiver also has the ability to be wired so it can shutdown the engine, mark a position on a compatible Chart Plotter, sound external alarm systems, and other options."}, {"index": "1", "heading": "Automatically Activated", "content": "Upon immersion in water, the ALERT Transmitter instantly sends a radio signal to the onboard ALERT2 Receiver to alarm the crew and vessel of a fall-overboard."}, {"index": "2", "heading": "Alerts in Seconds", "content": "When every second counts, the ALERT Man-Overboard Alarm System instantaneously alarms the vessel, providing the crew the critical extra seconds needed for a successful man overboard rescue. Unlike AIS, the response of the ALERT2 Receiver is immediate. There is no lag time connecting with satellites."}, {"index": "3", "heading": "Wired for Engine Kill", "content": "For singlehanders and solo fisherman, the ALERT Man-Overboard Alarm System can be wired to shut off the engine in the event of a fall-overboard, enabling the man overboard to get back to the boat."}, {"index": "4", "heading": "Plot Overboard Waypoint", "content": "The ALERT Man-Overboard Alarm System can easily connect to a compatible plotter to instantly mark the location of the fall overboard. Making it easier to home in the person that fell overboard. The ALERT2 Receiver can be directly wired to the boat’s 12-volt wiring system or connected via optional 110-volt power supply. An ALERT2 Receiver supports an unlimited number of ALERT2 or ALERT418 Transmitters."}]'
        },
        {
            ...
            categories: ['Overboard Alerting Products'],
            image: 'https://res.cloudinary.com/dccnlakey/image/upload/v1624403151/Emerald%20Marine%20Images/jtixi098jgxpdina8qui.png',
        ...
        },
        {
            ...
            image: 'https://res.cloudinary.com/dccnlakey/image/upload/v1624402253/Emerald%20Marine%20Images/zbwjlmyk1yztzmqmhkhn.jpg',
            ...
            width: '18 in',
            height: '6 ft',
            details: '[{"index": "0", "heading": "Description", "content": "OSCAR is designed and built to easily simulate the most realistic man-overboard rescue training of a human being. Training rescue crews using OSCAR will ensure that they are prepared to lift and move an adult sized human out of the water."}, {"index": "1", "heading": "Easily Transportable", "content": "OSCAR is a man-overboard dummy used for training water rescue personnel. OSCAR is designed for easily transporting to your training location. He weighs 35 pounds dry and 180 pounds when filled with water to replicate the size and weight of an adult."}, {"index": "2", "heading": "Constructed for Realistic Rescue Simulation", "content": "OSCAR floats at chest level like a human. At 180 pounds, he provides a very realistic human size and weight to properly train your rescue team for the recovery of a victim out of the water and into a rescue craft."}, {"index": "3", "heading": "Quickly Set up and Take down Training", "content": "Before use the bladders are filled with fresh or salt water from a deck hose. After the training exercise the bladders can be drained for transport and stowage. A galvanized shackle allows easy lifting from the shoulder."}, {"index": "4", "heading": "Durable and Built to Last", "content": "OSCAR is manufactured from extremely tough vinyl impact bladders with stainless steel joints to withstand repetitive drops overboard from any realistic height."}]'
        },
        {
            ...
            image: 'https://res.cloudinary.com/dccnlakey/image/upload/v1624403818/Emerald%20Marine%20Images/sius7qj3lzynqfskcpuf.jpg',
            alt: 'Stowage Bag for OSCAR Water Rescue Training Dummy',
            weight: 'N/A',
            length: 'N/A',
            width: 'N/A',
            height: 'N/A',
            details: '[{"index": "0", "heading": "Description", "content": "This durable, easy-to-carry OSCAR stowage bag makes a water rescue training dummy highly portable. The bag is made out of wire mesh material to resist the marine environment breakdown of normal materials and encases the entire OSCAR dummy so no break-down is needed. With an easy-to-carry stowage bag for your training dummy, you will be able to perform more regular and effective water rescue training sessions. The large U-Shape opening allows for easy drop-in loading of the entire OSCAR, no need to disassemble the unit for stowage or transport. Heavy-duty YKK zippers effortlessly encase the entire OSCAR unit inside the bag. This bag has a large center compartment for storing fill-nozzle and other useful training items. Two rubber grip handles sewn on ends allow carrying to be comfortable and stable. The nylon webbing shoulder strap makes transport of the OSCAR convenient and ergonomically safe. The bag’s wire mesh material is easy to wash. This bag is big, bold, durable, and can take the abuse of life on the boat and on the docks."}, {"index": "1", "heading": "Protect your portable rescue training dummy. Free Shipping Available Now!", "content": "You can order your OSCAR Water Rescue Training Dummy Stowage Bag exclusively through us and save on Free UPS Ground Shipping!"}]'
        },
        {
            ...
            categories: ['Overboard Alerting Products', 'Accessories'],
            image: 'https://res.cloudinary.com/dccnlakey/image/upload/v1624403913/Emerald%20Marine%20Images/ewc3un2pwd6lfsmsicca.jpg',
        ...
        },
        {
            ...
            width: '2',
            height: 'N/A',
            details: '[{"index": "0", "heading": "Description", "content": "The ALERT2 Man-Overboard Transmitter™ Pouch is designed to hold the ALERT2 Transmitter to attach to the Personal Flotation Device. This standard durable nylon pouch only needs to be purchased in the event that the ALERT2 Transmitter pouch needs to be replaced."}]'
        },
        {
            ...
            categories: ['Accessories'],
            image: 'https://res.cloudinary.com/dccnlakey/image/upload/v1624404083/Emerald%20Marine%20Images/jtey2fhewoqm5e3eotji.jpg',
            alt: 'ALERT2 Man-Overboard Transmitter™ Spray Tight Pouch',
            weight: '1.75 oz',
            length: '6.75',
            width: '3.75',
            height: '3',
            details: '[{"index": "0", "heading": "Description", "content": "The durable Spray Tight Pouch protects the ALERT2 Man-Overboard Transmitter from accidentally activating due to extreme water conditions onboard, while enabling it to activate when immersed in water due to a fall-overboard occurrence. The pouch folds completely over the ALERT2 Transmitter, making it seamless to wear. It is specifically recommended for those working in extreme water conditions, like those found on commercial fishing vessels."}]'
        },
        {
            ...
            categories: ['Accessories'],
            image: 'https://res.cloudinary.com/dccnlakey/image/upload/v1624407038/Emerald%20Marine%20Images/v6vgfbejejohxsfpaqqp.jpg',
            ...
            width: 'N/A',
            height: 'N/A',
            details: '[{"index": "0", "heading": "Description", "content": "The ALERT2 Man-Overboard Transmitter™ Replacement Batteries are a set of two (2) 3.6 volt lithium batteries used for replacement of batteries in ALERT2 Transmitter or ALERT2 Portable Direction Finder."}]'
        }
    ]
}